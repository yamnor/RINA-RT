...
def main():
  ...
  st.title("RIN Analyzer for HIV-1 RT")
  ...
  node['domain'] = ['F' for n in range(84)] + ['P' for n in range(35)] + ['F' for n in range(31)] + ['P' for n in range(93)] + ['T' for n in range(79)] + ['C' for n in range(115)] + ['R' for n in range(117)]
  node['resid'] = [n + 1 for n in range(554)]
